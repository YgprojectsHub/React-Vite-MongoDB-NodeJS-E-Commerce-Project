...
const Dialog = ({isDialogShow, setDialogShow}) => {
  ...
  return (
    <div className={`modal-dialog ${isDialogShow ? 'show':null}`}>
      <div className="modal-content">
        <button className="modal-close" onClick={() => setDialogShow(false)}>
      ...
      <div className="modal-overlay" onClick={() => setDialogShow(false)}></div>
    </div>
  );
};
